...
function handler(req,res){
   fs.readFile(__dirname + "/diod15.html",
   function (err, data) {
    if (err) {
...
var controlAlgorihtmStartedFlag = 1; // set flag that the algorithm has started
...
function controlAlgorithm () {
    err = desiredValue - actualValue; // error as difference between desired and actual var.
